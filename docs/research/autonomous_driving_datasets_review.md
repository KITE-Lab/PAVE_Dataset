...
![Sensor mounting positions](../images/research/zod/zod_sensor_setup.png)
...
### Example Annotations
![Annotated RGB](../images/research/zod/zod_annotations.png)
*Figure: Example of camera image with bounding boxes.*

---

### Scene Distribution
![Scene distribution](../images/research/zod/zod_scene_distribution.png)
...
![DNAT vs Blur (faces)](../images/research/privacy/anon-faces.png)<br>
![DNAT vs Blur (plates)](../images/research/privacy/anon-plates.png)
...
#### Sensor Mounting Layout  
  ![nuScenes Sensor Mounting](../images/research/nuscenes/nuscenes_sensor_setup.png)<br>
...
#### Semantic HD Map
  ![nuScenes Map Example](../images/research/nuscenes/nuscenes_map.png)<br>
...
### Camera Field of View (FOV)
  ![nuScenes Camera FOV](../images/research/nuscenes/nuscenes_camera_fov.png)<br>
...
![Waymo Sensor Mounting Positions](../images/research/waymo/waymo_sensor_setup.png)
...
![Waymo 3D Bounding Boxes in Point Cloud](../images/research/waymo/waymo_lidar_labels.png)
...
![Waymo LiDAR Points Projected onto Camera Image](../images/research/waymo/waymo_lidar_camera_projection.png)
...
![OpenOccupancy Annotation Comparison](../images/research/openoccupancy/OpenOccupancy_annotation_comparison.png)<br>
...
![OpenOccupancy Baseline Architectures](../images/research/openoccupancy/OpenOccupancy_baselines.png)<br>
...
![OpenOccupancy CONet](../images/research/openoccupancy/OpenOccupancy_conet.png)<br>
...
![OpenOccupancy Semantic Predictions](../images/research/openoccupancy/OpenOccupancy_predictions.png)<br>
